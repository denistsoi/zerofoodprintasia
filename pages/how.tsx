...
export default function Why() {
  return (
    <Layout>
      ...
      <section>
        <div className="relative px-4 sm:px-6 lg:px-8 bg-dark-green text-white py-8">
              ...
              <div className="col-span-4 md:col-span-2">
                <div className="p-4 border rounded-xl">
                  ...
                  <ul className="list-disc pl-4">
                    ...
                    <li className="text-sm lg:text-md md:leading-2 py-2">
                      Membership dues will be calculated in relation to
                      businesses operational emissions.
                    </li>
                    <li className="text-sm lg:text-md md:leading-2 py-2">
      ...
      <section>
        <div className="relative py-8 px-4 sm:px-6 lg:px-8 bg-light-green text-white">
          <div className="max-w-prose mx-auto">
      ...
      {/* Values */}
      <section>
        <div className="relative pb-16 pt-8 px-4 sm:px-6 lg:px-8 bg-black text-white">
          <div className="max-w-prose mx-auto">
            <div>
