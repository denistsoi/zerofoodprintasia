      ...
      <Layout>
        ...
        <section>
          <div className="relative bg-black">
            <div className="absolute inset-0 aspect-w-4 aspect-h-3">
              <Image
              ...
              <div className="max-w-prose mx-auto text-base py-4 md:py-8 text-white">
                <div>
                  <p>
                    ...
                    every day. Knowing that we want to do more but don't have
                    the time (or often, budget) to get around every aspect of
                    meeting best practices is a dilemma. 1% pledge will help you
                    get started on this journey towards collective action where
                    just a few dollars per sale can add up to make renewable
                    farming possible.
                  </p>
                </div>
                ...
                <div className="py-8">
                  ...
                  <div className="sm:max-w-sm pb-4">
                    <p className="pt-4">
                      ...
                      <em>
                        (And restaurants need to be serving better, more
                        traceable and ethically sourced food.)
                      </em>
                    </p>
                    <p className="pt-2">
                      Besides restoring our planet, becoming a ZFPA member
                      happens to pose additional benefits too.
                    </p>
              ...
              <div className="max-w-prose mx-auto">
                <div className="pt-10 pb-8">
                  ...
                  <h4 className="relative inline-block bg-dark text-white p-4">
                    Here are the 20 pilot ZFPA partners launching the 1% pledge
                    with us on June 1st, 2021.
                  </h4>
                </div>
